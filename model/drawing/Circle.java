...
public class Circle extends Shape {
	...
	public boolean pointInShape(Point2D.Double objCoord, double tolerance, double scale) {
        ...
        double distance = Math.sqrt(objCoord.x*(objCoord.x) + (objCoord.y)*(objCoord.y));
	...
	public Point2D.Double getUpperLeft() {
            return new Point2D.Double((center.x*2)-radius,(center.y*2)-radius);
	}

    @Override
    public boolean pointInHandle(Point2D.Double pt, double scale) {
