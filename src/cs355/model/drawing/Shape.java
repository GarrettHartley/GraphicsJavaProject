...
public abstract class Shape {
	 ...
	 */
	public abstract boolean pointInShape(Point2D.Double pt, double tolerance, double scale);
          
        public abstract boolean pointInHandle(Point2D.Double pt, double scale);
}
